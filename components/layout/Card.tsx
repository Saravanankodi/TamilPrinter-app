...
const Card = ({label,icon,disc,value,color}:CardProps) => {
  return (
    <>
    <section className="w-full max-w-65 h-auto p-6 bg-white rounded-lg border border-[#00000014] shadow-[0px_2px_4px_-1px_#00000008_0px_4px_6px_-1px_#0000000D] m-auto">
